...
float hive_id = 1; //this is device specific
...
void loop() {
  ...
  String temp_string = String(temperature, 2);
  String hive_id_string = String(hive_id, 2);
  ...
  LoRa.print(" hiveID:"); //This is how to transmit strings
  LoRa.print(hive_id_string);
  LoRa.endPacket();
